const Testimonials = () => {
    ...
    return (
        ...
        `}</style>
            <div className="max-w-5xl mx-auto px-4 md:px-0 py-20" id="testimonials">

                <h1 className="text-3xl font-semibold text-center mx-auto">What Our Clients Say</h1>
                <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">Hear what our users say about us. We're always looking for ways to improve. If you have a positive experience with us, leave a review.</p>
