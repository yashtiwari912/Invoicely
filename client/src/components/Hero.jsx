...
const Hero = () => {
    ...
    return (
        <>
            <div className="min-h-screen pb-20 pt-4 mt-7 bg-gray-50 overflow-hidden">


                {/* Hero Section */}
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-8 lg:px-16 xl:px-24 text-gray-900">
                    <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-blue-200 blur-[100px] opacity-30"></div>
                        ...
                        <div>
                            <div className="flex ">
                                {Array(5).fill(0).map((_, i) => (
                                    <svg key={i} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-transparent fill-teal-600" aria-hidden="true"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg>
                                ))}
                            </div>
                    ...
                    {/* Headline + CTA */}
                    <h1 className="text-4xl md:text-6xl font-semibold max-w-4xl text-center mt-6 md:leading-[70px]">
                        Smart Invoicing for Freelancers & Businesses
                    </h1>

                    <p className="max-w-xl text-center text-base my-7 text-slate-700">Create professional invoices, track expenses, and get paid faster with Invoicely.</p>

                    {/* CTA Buttons */}
                    <div className="flex items-center gap-3 flex-wrap justify-center">
                        <button onClick={() => navigate('/invoice')} className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-8 h-12 m-1 ring-offset-2 ring-1 ring-blue-500 flex items-center transition-colors cursor-pointer">
                            Start Free
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right ml-1 size-4" aria-hidden="true"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                        </button >
                        <button className="flex items-center gap-2 border border-teal-500 text-teal-600 hover:bg-teal-50 transition rounded-full px-7 h-12 cursor-pointer">
